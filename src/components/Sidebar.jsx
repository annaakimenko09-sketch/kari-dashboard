...
const sections = [
  ...
  {
    label: 'Наполненность Обувь',
    color: '#2563eb',
    items: [
      { path: '/filling/spb', label: 'СПБ', icon: BarChart2 },
      { path: '/filling/bel', label: 'БЕЛ', icon: BarChart2 },
    ],
  },
  {
