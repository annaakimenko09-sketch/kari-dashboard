  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="h-0.5 flex-shrink-0" style={{ backgroundColor: '#E31E24' }} />
        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 flex-shrink-0">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="w-1 h-6 rounded-full flex-shrink-0" style={{ backgroundColor: '#E31E24' }} />
            <div className="min-w-0">
              <h1 className="text-base font-bold text-gray-900 leading-tight truncate">{title}</h1>
              <p className="text-xs text-gray-400 leading-tight">
                Регион: СПБ и БЕЛ
                {parsedFiles.length > 0 && (
                  <span className="ml-2" style={{ color: '#E31E24' }}>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              <div className="w-4 h-4 rounded flex items-center justify-center text-white font-black text-xs" style={{ backgroundColor: '#E31E24' }}>K</div>
